...
* Blocking I/O has been relocated to run outside of the USB Interrupts.
    * This was causing timeout issues to occur, especially on devices that had been reprogrammed hundreds/thousands of times with larger binaries.
